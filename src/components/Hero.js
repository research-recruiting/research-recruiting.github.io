    ...
    <section id="overview" className="py-12 px-6">
      <div className="max-w-6xl mx-auto">
        <div className="bg-white/90 backdrop-blur-md rounded-3xl p-8 mb-12 shadow-lg border border-gray-200 relative">
          <div className="flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="text-center md:text-left text-gray-800">
              ...
              <div className="flex justify-center md:hidden mt-4">
                <button className="bg-secondary-500 text-white px-6 py-3 rounded-lg hover:bg-secondary-600 transition-colors font-medium shadow-lg flex items-center space-x-2">
          ...
          <button className="hidden md:flex absolute bottom-6 right-6 bg-secondary-500 text-white px-6 py-3 rounded-lg hover:bg-secondary-600 transition-colors font-medium shadow-lg items-center space-x-2">
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
